...
import 'package:jogo_da_memoria/dados/dados.dart';
...
class Facil extends StatefulWidget {
  ...
  @override
  _Facil createState() => _Facil();
}

class _Facil extends State<Facil> {
  @override
  void initState() {
    super.initState();
              ...
              pontos != 300
                  ? GridView(
                      ...
                      gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                          mainAxisSpacing: 0.0, maxCrossAxisExtent: 200),
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              color: Colors.pink,
                              onPressed: () {
                                Navigator.pop(context, '/dificuldade');
                              },
                            ),
                            IconButton(
